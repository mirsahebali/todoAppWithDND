...
export default function Todo({todo, text,  completed, toggleComplete, deleteTodo, prop1, prop2, inRef}:{todo: any, completed: boolean, toggleComplete:any, text: string, deleteTodo:any, prop1: any, prop2: any, inRef:any }) {
const styles:any = {
...
<div className={styles.row}>
          <input onChange={()=> toggleComplete(todo)} type="checkbox" placeholder="todo" checked={completed ? 'checked': ''}/>
